...
def main():
    ...
    def apagar_ultimos_leds():
        led4.off()
        led5.off()
        
    botao2.when_pressed = apagar_ultimos_leds
    ...
    def pisca_2():
        led4.blink(n=2, on_time=1, off_time=1)
        led5.blink(n=2, on_time=1, off_time=1)
    
    botao3.when_pressed = pisca_2
