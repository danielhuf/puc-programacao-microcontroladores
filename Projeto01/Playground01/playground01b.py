...
def main():
    ...
    player.volume = 70  # valor entre 0 e 100
    player.speed = 2  # valor < 1 -> mais lento ||| valor > 1 -> mais rápido
    ...
    duracao_em_minutos = str(int(duracao_em_segundos//60)) + ':' + str(int(duracao_em_segundos%60))
    print(duracao_em_minutos)
    ...
    botao2.when_pressed = aumenta
    botao3.when_pressed = diminui
