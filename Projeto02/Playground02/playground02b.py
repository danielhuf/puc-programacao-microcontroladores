...
def main():
    ...
    @app.route("/faz_coisas/<string:exibe>/<int:ene>")
    def faz_coisas(exibe, ene):
        lcd.clear()
        lcd.message(exibe)
        led1.blink(n=ene, on_time=0.5, off_time=0.5)
        return "Feito"
    ...
    @app.route("/pagina_feita_por_mim")
    def pagina_feita_por_mim():
    ...
    @app.route("/compara_peixe/<string:texto>")
    def compara_peixe(texto):
        if texto == "peixe-espada":
            led2.on()
