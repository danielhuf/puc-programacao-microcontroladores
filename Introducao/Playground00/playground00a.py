...
pais4 = {"nome": "Turelândia",           "capital": "Psiu",         "populacao": 2,  "democracia": False}
...
for pais in lista_de_paises:
    if pais['democracia']:
        ...
        string = ''
    print("%s é um país com %d habitantes cujo governo %sé uma democracia" %(pais['nome'], pais['populacao'], string))
